...
## Summary
- 1868 nodes · 3906 edges · 119 communities (103 shown, 16 thin omitted)
...
4. `assess_tender_integrity()` - 55 edges
...
Cohesion: 0.15
Nodes (16): GovPageHeader(), GovPageHeaderProps, useProcurement(), BidderVerification(), ProcurementDashboard(), ExtractedField, ProcurementDocuments(), ProcurementIntegrity() (+8 more)
...
Cohesion: 0.19
Nodes (31): create_bidder_record(), create_tender_record(), get_all_procurement_documents(), get_audit_trail(), get_bidder_documents(), get_compliance_results(), get_dashboard_summary(), get_db() (+23 more)
...
Cohesion: 0.09
Nodes (24): calculate_age_days(), calculate_days_remaining(), calculate_deadline(), get_deadline_status(), map_deadline_status_to_case_status(), map_deadline_status_to_priority(), map_deadline_status_to_risk_level(), parse_iso_date() (+16 more)
...
Cohesion: 0.12
Nodes (32): FormField(), FormFieldProps, inputBaseClasses, inputErrorClasses, selectBaseClasses, textareaBaseClasses, GovButton(), GovButtonProps (+24 more)
...
Cohesion: 0.12
Nodes (22): MOCK_AUDIT_LOGS, MOCK_BOTTLENECKS, MOCK_CASE_EVENTS, MOCK_CASES, MOCK_DASHBOARD_METRICS, MOCK_DOCUMENTS, MOCK_PERFORMANCE_METRICS, MOCK_PROCESS_MAP (+14 more)
...
Cohesion: 0.11
Nodes (19): get_project_bottlenecks(), calculate_stage_dwell_days(), detect_case_bottleneck(), Any, date, datetime, Bottleneck and File Stagnation Detection Engine. Analyzes case stage…, Calculate the number of days a case has been pending at its current stage.… (+11 more)

### Community 21 - "api/index.ts"
Cohesion: 0.13
Nodes (15): TableSkeleton(), Intelligence(), LA_WORKFLOW_STAGES, LandWorkflowStage, analyticsService, authService, dashboardService, documentService (+7 more)
...
### Community 27 - "react"
Cohesion: 0.09
Nodes (22): react, StatutoryDeadlineEngineProps, GovBadge, StatusBadge(), StatusBadgeProps, StatutoryCountdownProps, TechnicalCardProps, DOCUMENT_TYPES (+14 more)
...
### Community 30 - "generate_la_recommendations"
Cohesion: 0.33
...
Cohesion: 0.16
Nodes (25): actor_name(), add_bidder_to_tender(), BidderCreate, create_tender(), DecisionRequest, FindingReviewRequest, BaseModel, post (+17 more)
...
### Community 36 - "get_tender_by_id"
Cohesion: 0.20
Nodes (10): get_tender_detail(), get_tender_integrity_endpoint(), Fetch complete tender requirements and metadata., Run deterministic integrity analysis for a tender and its participating bidders., get_tender_by_id(), Convert an sqlite3.Row to a standard python dict with JSON deserialization., row_to_dict(), get_tender_bidder_features() (+2 more)
...
Cohesion: 0.25
Nodes (7): calculate_risk(), calculate_stage_dwell_days(), Calculate how many days the case has been at its current stage. Uses…, Calculate a transparent risk score for a case. Args: case: Raw case dict from…, Tests for risk_service.py — no database needed., Helper to create a minimal case dict for risk calculation., TestRiskService

### Community 39 - "AuditLogs.tsx"
Cohesion: 0.25
Nodes (6): GovTable(), GovTableProps, TableColumn, auditService, riskService, AuditLog
...
Cohesion: 0.09
Nodes (31): Update the status of a case (PENDING, APPROVED, DISPOSED, etc.)., update_status(), get_dashboard_metrics(), get, Returns aggregate operational statistics computed from the live database. Every…, list_projects(), put, update_project() (+23 more)
...
### Community 53 - "get_bidder_by_id"
Cohesion: 0.12
Nodes (20): get_bidder_compliance(), get_bidder_detail(), get_bidder_documents_list(), get_bidder_integrity_endpoint(), get_document_evidence(), get_procurement_audit(), get_procurement_dashboard(), list_all_documents() (+12 more)
...
Cohesion: 0.11
Nodes (18): post, UploadFile, Trigger OCR processing on an already-uploaded document. Pipeline: 1. Retrieve…, Upload a document and attach it to a case. - Validates file type (PDF, PNG,…, run_ocr_on_document(), upload_document(), create_project(), post (+10 more)

### Community 64 - "intelligence/__init__.py"
Cohesion: 0.11
Nodes (42): Constants and Configuration for the Case Intelligence & Risk Engine. All…, calculate_case_age(), calculate_days_remaining(), calculate_deadline_status(), calculate_statutory_deadline(), classify_deadline_status(), determine_delay_status(), normalize_to_date() (+34 more)
...
Cohesion: 0.07
Nodes (46): _enrich_project_with_ml(), get_project(), get_project_delay_factors(), get_project_prediction(), get_project_recommendations(), get_project_timeline(), LandProjectCreate, LandProjectUpdate (+38 more)
...
### Community 103 - "ProjectDetail.tsx"
Cohesion: 0.33
Nodes (4): GovModal(), GovModalProps, projectService, OCRResult
...
Cohesion: 0.24
Nodes (9): App(), ProtectedRoute(), PublicRoute(), useAuth(), Search(), Settings(), VERIFICATION_SOURCES, VerificationSource (+1 more)
...
- **Why does `get_supabase()` connect `get_supabase` to `projects.py`, `security.py`, `seed.py`, `get_document`, `case_service.py`, `auth.py`, `alert_service.py`, `list_alerts`, `detect_case_bottleneck`, `cases.py`, `ocr_service.py`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `validate_file()` connect `validate_file` to `test_documents.py`, `projects.py`, `deadline_service.py`, `.test_validate_file_returns_none_on_success`, `.test_validate_file_returns_string_on_error`, `process_ocr`, `ocr_service.py`, `procurement.py`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `get_current_user()` connect `security.py` to `test_integrity_engine.py`, `projects.py`, `get_supabase`, `auth.py`, `get_bidders`, `cases.py`, `procurement.py`?**
